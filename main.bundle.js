...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(CreateGrudge, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement('input', { className: 'CreateGrudge-title',
	          name: 'title',
	          placeholder: 'Title',
	...
	var GrudgesListItem = function GrudgesListItem(_ref2) {
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      'h3',
	      { className: 'GrudgesListItem-title' },
	      title
	    ),
	    React.createElement(
	      'div',
	      { className: 'GrudgesListItem-body' },
	      body
	    ),
	    React.createElement(
	      'div',
	...
	var ActiveGrudge = function ActiveGrudge(_ref3) {
	  ...
	  return React.createElement(
	    'div',
	    { className: 'ActiveGrudge' },
	    React.createElement('input', { className: 'ActiveGrudge-title',
	      name: 'title',
	      value: grudge.title,
	      onChange: updateGrudge
	    }),
	    React.createElement('textarea', { className: 'ActiveGrudge-body',
	      name: 'body',
	      value: grudge.body,
	      onChange: updateGrudge
	    })
	...
	ReactDOM.render(React.createElement(GrudgeBox, { title: 'Grudge Box' }), document.querySelectory('.application'));
